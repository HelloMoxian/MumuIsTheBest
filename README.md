...
项目已采用 React + Vite + Fastify，并已创建阿里云 Fun-ASR 实时语音识别、五个正式数学玩法、“元素周期表”“反应熔炉”“分子工厂”“物质守恒”四个化学模块，以及“拼音星桥”“常用汉字”两个语文模块。
...
8. 首页进入“化学 → 物质守恒”，选择题数和难度，通过数字控制台调整化学式前的系数，让箭头两边每一种原子都一样多。
