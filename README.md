...
项目已采用 React + Vite + Fastify，并已创建阿里云 Fun-ASR 实时语音识别、五个正式数学玩法、“元素周期表”“反应熔炉”“物质守恒”三个化学模块，以及“拼音星桥”“常用汉字”两个语文模块。
...
6. 首页进入“化学 → 反应熔炉”，从右侧原子仓投放原子，观察它们运动、聚合并组成每批随机出现的 10 种物质；每批固定 2 种有机物，并先随机确定 10 种优先元素。
